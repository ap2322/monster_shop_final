...
RSpec.describe 'Item Index Page' do
  describe 'As a visitor' do
    before :each do
      ...
      @order_1 = @user.orders.create!(address_id: @user.addresses.first.id)
      @order_2 = @user.orders.create!(address_id: @user.addresses.first.id)
      @order_3 = @user.orders.create!(address_id: @user.addresses.first.id)
