...
RSpec.describe 'Admin Dashboard' do
  describe 'As an Admin' do
    before :each do
      ...
      @order_1 = @m_user.orders.create!(address_id: @m_user.addresses.first.id, status: "packaged")
      @order_2 = @m_user.orders.create!(address_id: @m_user.addresses.first.id, status: "pending")
      @order_3 = @m_user.orders.create!(address_id: @m_user.addresses.first.id, status: "cancelled")
