...
RSpec.describe 'Order Show Page' do
  describe 'As a Registered User' do
    before :each do
      ...
      @user = create(:user, :with_addresses, address_count: 2)
      @order_1 = @user.orders.create!(address_id: @user.addresses.first.id, status: "packaged")
      @order_2 = @user.orders.create!(address_id: @user.addresses.last.id, status: "pending")
